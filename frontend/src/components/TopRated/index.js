...
const TopRared = ({ setMoviesLength }) => {
  ...
  const topRated = () => {
    axios
      .get(
        "https://api.themoviedb.org/3/movie/top_rated?api_key=1bfa430aada4409bfa6a3c5528128e8a&language=en-US&page=1"
      )
      .then((result) => {
  ...
  const loadMore = () => {
    ...
    axios
      .get(
        `https://api.themoviedb.org/3/movie/top_rated?api_key=1bfa430aada4409bfa6a3c5528128e8a&language=en-US&page=${id}`
      )
      .then((result) => {
